...
namespace GAME
{
    ...
    public class GPlayerCmd
    {
        ...
        public void OnTest(string sCmd, string sParam0, string sParam1, string sParam2, string sParam3, string sParam4, string sParam5, string sParam6)
        {
